...
ax1 = axs[0]
ax2 = ax1.twinx()
bars = ax1.bar(bin_edges[:-1], pdf_counts, width=bin_widths, align="edge", alpha=1.0, color=(40/255,120/255,181/255), label="PDF", zorder=2)
line, = ax2.step(bin_edges, cdf, where="post", color=(200/255,36/255,35/255), linewidth=2, label="CDF", zorder=2)
ax1.set_xlabel("INA efficiency score")
ax1.set_ylabel("PDF")
ax2.set_ylabel("CDF")
ax1.set_title("Shared by 3 jobs", fontsize=12)
ax1.grid(axis="y", zorder=0)
ax1.set_xlim(0.4, 1)
vl1 = ax1.axvline(x=mean, color="red", linestyle="--", linewidth=1, label="Mean")
vl2 = ax1.axvline(x=median, color="blue", linestyle="--", linewidth=1, label="Median")
...
ax1.set_ylabel("PDF")
ax2.set_ylabel("CDF")
ax1.set_title("Shared by 4 jobs", fontsize=12)
ax1.grid(axis="y", zorder=0)
ax1.set_xlim(0.4, 1)
vl1 = ax1.axvline(x=mean, color="red", linestyle="--", linewidth=1, label="Mean")
vl2 = ax1.axvline(x=median, color="blue", linestyle="--", linewidth=1, label="Median")
